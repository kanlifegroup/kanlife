                         ...
                         <div class="card-body">
                           ...
                           <div id="ifExpress" @if($setting['setting']->paypal_type == 'express') class="force-block" @else class="force-none" @endif>
                            ...
                            <div class="card-body">
                             ...
                             <div class="col-md-12"><div class="card-body"><h4>{{ Helper::translation('62f9e4b998522',$translate,'CoinPayments') }}</h4></div></div>
                             <div class="col-md-6">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation('62f9e4c1e015b',$translate,'CoinPayments Merchant ID') }} <span class="require">*</span></label><br/>
