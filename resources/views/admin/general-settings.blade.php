                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <label for="product_approval" class="control-label mb-1">Product SKU Field Type<span class="require">*</span></label><br/>
                                       <select name="sku_type" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="auto" @if($additional['setting']->sku_type == "auto") selected @endif>Auto Generate</option>
                                                <option value="manual" @if($additional['setting']->sku_type == "manual") selected @endif>Manual</option>
                                                </select>
