                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-gear"></i><a href="{{ url('/admin/tax-settings') }}">Tax Settings</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-flag"></i><a href="{{ url('/admin/country-settings') }}">{{ Helper::translation(2007,$translate,'') }}</a></li>
                            <li><i class="fa fa-flag"></i><a href="{{ url('/admin/postcode') }}">Postcode</a></li>
                        </ul>
                    </li>
                    @endif
                    @endif
