                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $withdraw)
                                        <tr>
                                            ...
                                            <td>@if($withdraw->withdraw_status == 'paid')<span class="badge badge-success">{{ $withdraw->withdraw_status }}</span>@else <span class="badge badge-danger">{{ $withdraw->withdraw_status }}</span> @endif</td>
                                            <td>
                                            ...
                                            @endif
                                            @if($demo_mode == 'on') 
                                            <a href="{{ URL::to('/admin/demo-mode') }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;{{ Helper::translation(1967,$translate,'') }}</a>
                                            @else
                                            <a href="{{ URL::to('/admin/withdrawal') }}/{{ $withdraw->wid }}" class="btn btn-danger btn-sm" onClick="return confirm('{{ Helper::translation(1968,$translate,'') }}');"><i class="fa fa-trash"></i>&nbsp;{{ Helper::translation(1967,$translate,'') }}</a>@endif
                                            </td>
