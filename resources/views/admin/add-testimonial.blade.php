                              ...
                              <div id="pay-invoice">
                                <div class="card-body">
                                  <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control noscroll_textarea" value="" data-bvalidator="required"> 
                                  </div>
                                  <div class="form-group">
                                    <label for="description" class="control-label mb-1">Description <span class="require">*</span></label>
                                    <textarea name="description" id="description" rows="3" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[1000]"></textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div id="pay-invoice">
                                <div class="card-body">
                                  <div class="form-group">
                                    ...
                                    <input id="designation" name="designation" type="text" class="form-control noscroll_textarea" value="" data-bvalidator="required"> 
                                  </div>
                                  <div class="form-group">
