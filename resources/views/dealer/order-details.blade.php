                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="{{ url('/dealer/orders') }}" class="btn btn-success btn-sm"><i class="fa fa-chevron-left"></i> {{ Helper::translation(2088,$translate,'') }}</a>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <form action="{{ route('dealer.order-track') }}" class="setting_form" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                           ...
                                           {{--<td>
                                            ...
                                            <a href="{{ URL::to('/dealer/order-details') }}/{{ $order->ord_id }}/vendor" class="btn btn-success btn-sm" title="payment released to vendor" onClick="return confirm('Are you sure you will payment released to vendor?');"><i class="fa fa-money"></i>&nbsp; {{ Helper::translation(3600,$translate,'') }}</a> 
                                            <a href="{{ URL::to('/dealer/order-details') }}/{{ $order->ord_id }}/buyer" class="btn btn-danger btn-sm" title="payment released to buyer" onClick="return confirm('Are you sure you will payment released to buyer?');"><i class="fa fa-close"></i>&nbsp; {{ Helper::translation(3606,$translate,'') }}</a>
                                            @else
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $allsettings->site_currency_symbol }}{{ $single_data->vat_price }}
                                        </td>
                                    </tr>
                                    @endif
                                    {{--
