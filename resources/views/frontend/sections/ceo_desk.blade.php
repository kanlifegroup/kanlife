    ...
    <div class="row deu-deskbg">
      ...
      <div class="col-md-8 col-sm-6">
        <div class="about-title clearfix">
          <div class="sub-head">Shri, Ramesh Verma, IAS,</div >
          <h6 class="deu-chief">Chief Electoral Officer, Goa</h6>
          <hr>
          <h6 class="mt-4 deu-ceos">&nbsp;&nbsp;&nbsp;&nbsp; lorem lorem lorem lorem lorem lorem lorem
          ...
          <h6 class="mt-4 deu-ceos">&nbsp;&nbsp;&nbsp;&nbsp; lorem lorem lorem lorem lorem lorem lorem
              ...
              lorem lorem lorem lorem lorem lorem lorem lorem lorem </h6>
          <h6 class="mt-4 deu-ceos">&nbsp;&nbsp;&nbsp;&nbsp; lorem lorem lorem lorem lorem lorem lorem
              lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem </h6>
        </div>
      </div>
    </div>
  </div>
