          ...
          <div class="col-md-12 deu-personalline px-4">
              <div class="row col-12 mt-4">
                  ...
                  <div class="col-md-6 position-relative">
                      ...
                      <span class="seepassword" style="display:none; top:60px;" onclick="hide_password(this)"><i class="fa fa-eye"></i></span>
                      <span class="seepassword" style="top:60px;" onclick="see_password(this)"><i class="fa fa-eye-slash"></i></span>
            @error('password')
              <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
              </span>
