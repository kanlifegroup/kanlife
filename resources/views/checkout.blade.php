         ...
         <div class="row">
           <div class="col-md-6 mt-1 mb-1 pt-1 pb-1">
               <h3>{{ Helper::translation(1997,$translate,'') }}</h3>
                ...
                <div class="col">
                  ...
                  <input type="text" class="form-control" id="bill_firstname" name="bill_firstname" value="@if($checkout_data != 0){{ $checkout_details->bill_firstname }}@endif" data-bvalidator="required,alpha">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(1999,$translate,'') }}<span class="red">*</span></label> 
                  <input type="text" class="form-control" id="bill_lastname" name="bill_lastname" data-bvalidator="required,alpha" value="@if($checkout_data != 0){{ $checkout_details->bill_lastname }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2000,$translate,'') }}</label>
                  <input type="text" class="form-control" id="bill_companyname" name="bill_companyname" value="@if($checkout_data != 0){{ $checkout_details->bill_companyname }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2001,$translate,'') }}<span class="red">*</span></label> 
                  <input type="text" class="form-control" id="bill_email" name="bill_email" data-bvalidator="email,required" value="@if($checkout_data != 0){{ $checkout_details->bill_email }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2002,$translate,'') }}<span class="red">*</span></label>
                  <input type="text" class="form-control" id="bill_phone" name="bill_phone" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->bill_phone }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2003,$translate,'') }}<span class="red">*</span></label> 
                  <input type="text" class="form-control" id="bill_address" name="bill_address" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->bill_address }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2004,$translate,'') }} <span class="red">*</span></label>
                  <input type="text" class="form-control" id="bill_city" name="bill_city" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->bill_city }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2005,$translate,'') }} <span class="red">*</span></label> 
                  <input type="text" class="form-control" id="bill_state" name="bill_state" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->bill_state }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2006,$translate,'') }} <span class="red">*</span></label>
                  <input type="text" class="form-control" id="bill_postcode" name="bill_postcode" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->bill_postcode }}@endif">
                </div>
                <div class="col">
           ...
           <div class="col-md-6 mt-1 mb-1 pt-1 pb-1">
               ...
               <div id="show_shipping">
                ...
                <div class="col">
                  <label>{{ Helper::translation(1998,$translate,'') }}<span class="red">*</span></label>
                  <input type="text" class="form-control" id="ship_firstname" name="ship_firstname" data-bvalidator="required,alpha" value="@if($checkout_data != 0){{ $checkout_details->ship_firstname }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(1999,$translate,'') }} <span class="red">*</span></label> 
                  <input type="text" class="form-control" id="ship_lastname" name="ship_lastname" data-bvalidator="required,alpha" value="@if($checkout_data != 0){{ $checkout_details->ship_lastname }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2000,$translate,'') }}</label>
                  <input type="text" class="form-control" id="ship_companyname" name="ship_companyname" value="@if($checkout_data != 0){{ $checkout_details->ship_companyname }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2001,$translate,'') }} <span class="red">*</span></label> 
                  <input type="text" class="form-control" id="ship_email" name="ship_email" data-bvalidator="email,required" value="@if($checkout_data != 0){{ $checkout_details->ship_email }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2002,$translate,'') }} <span class="red">*</span></label>
                  <input type="text" class="form-control" id="ship_phone" name="ship_phone" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->ship_phone }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2003,$translate,'') }} <span class="red">*</span></label> 
                  <input type="text" class="form-control" id="ship_address" name="ship_address" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->ship_address }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2004,$translate,'') }} <span class="red">*</span></label>
                  <input type="text" class="form-control" id="ship_city" name="ship_city" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->ship_city }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2005,$translate,'') }} <span class="red">*</span></label> 
                  <input type="text" class="form-control" id="ship_state" name="ship_state" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->ship_state }}@endif">
                </div>
              </div>
              <div class="form-row mt-3 mb-3">
                <div class="col">
                  <label>{{ Helper::translation(2006,$translate,'') }} <span class="red">*</span></label>
                  <input type="text" class="form-control" id="ship_postcode" name="ship_postcode" data-bvalidator="required" value="@if($checkout_data != 0){{ $checkout_details->ship_postcode }}@endif">
                </div>
                <div class="col">
                  <label>{{ Helper::translation(2007,$translate,'') }} <span class="red">*</span></label> 
                  ...
                  <option value=""></option>
                  @foreach($allcountry as $country)
                  <option value="{{ $country->country_id }}" @if($checkout_data != 0) @if($country->country_id == $checkout_details->ship_country) selected @endif @endif>{{ $country->country_name }}</option>
                  @endforeach
                  </select>
                </div>
              </div>
