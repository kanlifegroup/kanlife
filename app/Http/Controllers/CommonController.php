...
class CommonController extends Controller
{
  ...
  public function ourBlog(Request $request){
    ...
    $blogPost['latest'] = Blog::getLatestPostData($translate, $take, $category_id);
  ...
  public function view_category($slug)
  {
    ...
    if(!$links->count())
    $links = Product::where('product_status','=',1)->where('product_drop_status','=','no')->where('language_code','=',$translate)->inRandomOrder()->whereNotIn('product_id',[$shop->product_id])->limit(10)->get();
