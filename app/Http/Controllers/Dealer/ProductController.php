...
class ProductController extends Controller
{
	...
	public function view_brands()
  {
	...
	{
       $ord_id = base64_decode($order_id);
      
	  
      Product::deleteOrderdata($ord_id);
  ...
  public function delete_withdrawal($wid)
	{
	   
	   Product::deleteWithdraw($wid);
  ...
  public function edit_brand($brand_id)
	...
	public function view_orders()
	{
	   ...
	   $itemData['item'] = DB::table('product_checkout')->join('users','users.id','product_checkout.user_id')->whereIn('product_checkout.ord_id', $ord_ids)->orderBy('product_checkout.cid', 'desc')->get(); 
	   $data = array('itemData' => $itemData);
	   return view('dealer.orders')->with($data);
	}
	...
	public function view_products()
  {
	...
	public function edit_product($product_token)
	{
	   ...
	   return view('dealer.edit-product',['edit' => $edit, 'product_categories' => $product_categories, 'editimage' => $editimage, 'product_attribute' => $product_attribute, 'brand' => $brand, 'languages' => $languages]);
	}
	...
	public function update_product(Request $request)
	{
	   ...
	   if ($validator->fails())
        ...
        return redirect('/dealer/products')->with('success', 'Update successfully.');
	...
	public function add_product()
	{
	   $brand['view'] = Product::homebrandData();
     $languages['data'] = Languages::pageLanguage();
	   return view('dealer.add-product',[ 'brand' => $brand, 'languages' => $languages]);
	}
	...
	public function save_product(Request $request)
	{
		...
		{ 
		 ...
		 foreach($data['language_code'] as $index => $code)
			  ...
			  return redirect('/dealer/products')->with('success', 'Insert successfully.');
		}
