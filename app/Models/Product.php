...
class Product extends Model
{
  ...
  public static function deleteWithdraw($wid)
  {
    
		
	DB::table('product_withdraw')->where('wid', '=', $wid)->delete();	
  ...
  public static function Checkoutdata($user_id)
  {

    $value=DB::table('product_checkout')->where('user_id', '=', $user_id)->orderBy('cid', 'desc')->first();
    return $value;
	
  }
  public static function countCheckout($user_id)
  {

    $get=DB::table('product_checkout')->where('user_id', '=', $user_id)->orderBy('cid', 'desc')->get();
	$value = $get->count(); 
    return $value;
  ...
  public static function deleteOrderdata($ord_id)
  {
    
	
	
	DB::table('product_orders')->where('purchase_token', '=', $ord_id)->delete();	
	DB::table('product_checkout')->where('purchase_token', '=', $ord_id)->delete();
 ...
 public static function insertbrandData($data){
  ...
  public static function getEnquiries(){
    return DB::table('price_enquiry')->join('product','product.product_id','price_enquiry.product_id')->join('users','users.id','price_enquiry.user_id')->select('price_enquiry.id','price_enquiry.status','price_enquiry.created_at','product.product_name','product.product_sku','users.name','users.email','users.user_phone')->get();
  }
