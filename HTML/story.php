...
<link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@500&family=Montserrat:wght@500&family=Nunito:wght@200;300;500;600;700;900&family=Roboto:wght@500&display=swap" rel="stylesheet">
</head>
<body>
...
<div class="us-section">
<div class="container">
<h3 class="text-center mb-5 deu-gethead">GET IN TOUCH</h3>
<div class="row">
    ...
    <div class="col-md-7 col-sm-6">
        <div class="about-title clearfix">
            <p class="mt-3 mb-3">Kanlife Group was conceptualized and founded in 2009 in Singapore as Kanlife Asia Pte. Ltd. with a vision to provide a go-to-market 
                platform to medical technology and healthcare companies from across the globe that are looking to establish a presence or strengthen their distribution foothold in Asia.</p>
