...
<div class="container">
<h3 class="text-center mt-5 mb-5 deu-bloghead">X-Ray Systems</h3>
</div>
...
<div class="container-fluid">
  ...
  <div class="col-md-4">
    ...
    <div class="chiller_cb">
      ...
      <label for="myCheckbox2">HF Mobile radiography system</label>
      <span></span>
    </div>
    <div class="chiller_cb">
      <input id="myCheckbox3" type="checkbox">
      <label for="myCheckbox3">Portable DR</label>
      <span></span>
    </div>
    <div class="chiller_cb">
      <input id="myCheckbox4" type="checkbox">
      <label for="myCheckbox4">High frequency fixed RAD systems</label>
      <span></span>
    </div>
	  </div>
  ...
  <div class="col-md-8">
      <div class="row">
      <div class="col-md-6">
        <p class="deu-Show">Show 1-6 of 18 results</p>
      </div>
