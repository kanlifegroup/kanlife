                ...
                <div class="row">
                  <div class="col-md-12">
                      <div class="card">
                           ...
                           @else
                            <form action="{{ route('dealer.edit-product') }}" method="post" id="category_form" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           @endif
                           <div class="col-md-6">
                           <div class="card-body">
                            ...
                            <label for="name" class="control-label mb-1">{{ Helper::translation(2982,$translate,'') }} <span class="require">*</span></label>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="product_price" name="product_price" type="text" class="form-control" value="{{ $edit['product']->product_price }}">
                                            </div>
                                             <div class="form-group">
