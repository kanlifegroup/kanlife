<div class="us-section" style="background:#fff" >
    <div class="container">
        <h3 class="text-center mb-5 deu-bloghead" aos="fade-up">GET IN TOUCH</h3>
        <div class="row">
            <div class="col-md-5 col-sm-6">
                <div class="about-img" aos="fade-right">
                    <img class="img-fluid mt-2 deu-marg" src="{{ asset('public/kanlife/touch.jpg') }}" alt="">
                </div>
            </div>
