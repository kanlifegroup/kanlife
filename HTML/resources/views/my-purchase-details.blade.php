           ...
           <div class="col-md-12">
         	   <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        ...
                        @if($purchase->payment_token != ""){{ $purchase->payment_token }}@else <span>---</span> @endif
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="form-group row">
                    ...
                    @if($purchase->vat_price != 0)
                    <div class="col-sm-3">
                        <label for="name">Tax Price (VAT) : </label>
                        {{ $allsettings->site_currency_symbol }}{{ $purchase->vat_price }}
                    </div>
                    @endif
                    <div class="col-sm-3">
