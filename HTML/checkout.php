  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown ">
            <button type="button" class="btn btn-link dropdown-toggles deu-dropdowns active" data-toggle="dropdown">
            About
            </button>
...
<div class="container-fluid mt-5 mb-5">
		...
		<div class="col-md-7">
			<div class="panel panel-info">
				<div class="panel-body deu-cardborder">
					<div class="row m-4">
						<div class="col-md-3">
              <img class="img-fluid deu-cardimg" alt="deatils" src="image/details.png">
              ...
              <h4 class="deu-cardrs">400</h4>
						</div>
						<div class="col-md-3">
							<div class="text-right">
								<h6 class="mt-5 deu-cardremove">REMOVE</h6>
							</div>
						</div>
					</div>
					<hr>
              ...
              <h4 class="deu-cardrs">400</h4>
				...
				<div class="panel-footer mt-5">
					<div class="row text-right">
						<div class="col-md-12">
              <a href="#" class="round-black-btn">Proceed to checkout</a>
						</div>
					</div>
				</div>
			</div>
    ...
    <div class="col-md-5">
      ...
      <a href="#" class="round-black-btn">Apply Coupon</a>
      </form>
      </div>
		</div>
	</div>
