...
<div class="container-fluid bgteam-overlay">
    ...
    <p class="deu-orderno">Order No. #OD1234K1</p>
	</div>
</div>
...
<div class="container-fluid mt-5 mb-5">
			...
			<div class="panel panel-info">
              ...
              <form action="#" class="display-flex">
                ...
                <div class="qtyplus">+</div>
						...
						<div class="col-md-6">
							<h4 class="deu-cardsname mt-5">Skanmobile</h4>
              <h4 class="deu-cardrs"><i class="fa fa-inr" aria-hidden="true"></i> 400</h4>
						</div>
					</div>
					<hr>
					<div class="row m-4">
    ...
    <div class="col-md-5">
      ...
      <p class="deu-homes1"><span>Jesmin Patel</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>9090897865</span></p>
        <p class="deu-homes2">#212, Srinivasa Reddy Building, 2nd floor, opp. Oxford school, 10th cross J.P nagar, 
          1st phase, Bangalore, Karnataka, Jp nagar 1st phase, BANGALORE, Karnataka - 560078</p>
      </div>
