    ...
    <div class="container-fluid top-nav text-white py-2">
        <div class="row g-0 align-items-center flex-column gap-3 justify-content-center flex-md-row">
            ...
            <div class="col-auto d-flex align-items-center gap-2 px-5">
                <img class="top-navemail" alt="kanlife email" src="image/email.svg" />
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-nav mb-3 mb-lg-0 ms-auto gap-0 gap-lg-4 align-items-lg-center">
                    ...
                    <div class="cart-icon">
                        <img src="image/cart-after-login.svg" alt="kanlife login" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="home-doctors  text-center doc-item">
                                <div
                                    ...
                                    <div class="deu-xrayfigure">
                                        <p class="deu-closed btn-close"></p>
                                        <img src="image/system.png"
                                            class="deu-widauto img-fluid doc-img animate attachment-gallery-post-single wp-post-image"
                                            alt="Wishlist Products">
                                    </div>
