      ...
      <div id="thumb" class="owl-carousel product-thumb">
        ...
        <div class="col-md-4">
          <div class="product-dtl">
            <div class="product-info mb-3">
              ...
              <div class="product-price-discount"><span><i class="fa fa-inr" aria-hidden="true"></i> 200</span>
              <span class="line-through"><i class="fa fa-inr" aria-hidden="true"></i> 300</span></div>
            </div>
        ...
        <ul class="deu-proul">
          ...
          <a href="#" class="round-black-btn">Add To Cart</a>
            ...
            <p class="deu-add"><i class="fa fa-heart-o" aria-hidden="true"></i> Add To Wishlist</p>
          </div>
        </div>
        <div class="col-md-4">
