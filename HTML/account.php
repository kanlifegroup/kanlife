        ...
        <div class="row g-0 align-items-center flex-column gap-3 justify-content-center flex-md-row">
            <div class="col d-flex gap-2 justify-content-center justify-content-md-start px-3">
                <div class="social-bg d-flex justify-content-center align-items-center">
                    <img src="image/facebook.svg" alt="kanlife facebook" class="img-fluid">
                </div>
                <div class="social-bg d-flex justify-content-center align-items-center">
                    <img src="image/instagram.svg" alt="kanlife instagram" class="img-fluid">
                </div>
                <div class="social-bg d-flex justify-content-center align-items-center">
                    <img src="image/youtube.svg" alt="kanlife youtube" class="img-fluid">
                </div>
                <div class="social-bg d-flex justify-content-center align-items-center">
                    <img src="image/twitter.svg" alt="kanlife twitter" class="img-fluid">
                </div>
                <div class="social-bg d-flex justify-content-center align-items-center">
                    <img src="image/linkedin.svg" alt="kanlife linkedin" class="img-fluid">
                </div>
            </div>
            <div class="col-auto d-flex align-items-center gap-2 px-5">
                <img class="top-navemail" src="image/email.svg" />
            ...
            <div class="col-auto text-white d-flex align-items-center optionbox">
                <div class="dropdown-center">
                    <button class="btn bg-transparent text-white d-flex align-items-center gap-2 dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="top-navemail ms-auto me-0" alt="global" src="image/global.svg">
                        India
                        <img src="image/counrty-dd-icon.svg" alt="countries" width="15" class="ms-5">
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="index.html">India</a></li>
                        <li><a class="dropdown-item" href="home_singapore.html">Singapore</a></li>
                        <li><a class="dropdown-item" href="home_london.html">London</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg py-0">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-nav mb-3 mb-lg-0 ms-auto gap-0 gap-lg-4 align-items-lg-center">
                    <div class="dropdown">
                    ...
                    <a class="nav-link text-nowrap" href="#">Dr. Consultant</a>
                    <a class="nav-link" href="#">About</a>
                    <div class="dropdown">
                        <button class="btn nav-link border-0 dropdown-toggle" type="button" id="dropdownMenuButton1"
                    ...
                    <button class="deu-login btn text-white py-1 px-4" data-toggle="modal"
                ...
                <div class="col-md-12 deu-personalline px-4">
                    <div class="row col-12 mt-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" placeholder="Name" class="form-control deu-checkinput">
                        </div>
                        <div class="col-md-6">
                            <label class="deu-contactadress">Password</label>
                            <input type="text" placeholder="Password" class="form-control deu-checkinput">
                        </div>
                    </div>
                    <div class="row col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" placeholder="Confirm Password" class="form-control deu-checkinput">
                        </div>
                    </div>
                    <div class="row col-12">
                        <div class="col-md-6">
                    ...
                    <div class="text-center">
                        <button class="deu-editbtn px-5">Edit Profile</button>
                    </div>
                </div>
            </div>
        </div>
